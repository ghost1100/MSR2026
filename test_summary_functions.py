...
print(f"✅ Test analysis complete: {test_stats['Test_PRs'].sum()} test PRs found")

# Test ratios calculation
print("\nTesting test-to-code ratios calculation...")
ratios = calculate_test_code_ratios(df_analyzed)
print(f"✅ Ratios calculated: {ratios['overall']['test_ratio']:.3f} overall test ratio")

# Test research summary
print("\nTesting research summary...")
summary = get_research_summary(df_analyzed)
print(f"✅ Summary generated: {summary['unique_agents']} agents, {summary['dataset_size']} PRs")
