...
def test_claude_integration():
    ...
    try:
        ...
        print("PASS: Dependencies imported")
    ...
    try:
        ...
        print(f"PASS: Data loaded: {len(df)} records")
    except Exception as e:
    ...
    try:
        ...
        print("PASS: Claude analyzer initialized")
    except Exception as e:
        print(f"FAIL: Claude analyzer error: {e}")
        return False
    ...
    try:
        ...
        print(f"PASS: API test successful!")
...
def main():
    ...
    if success:
        ...
        print("\nFAIL: Claude integration test failed")
        print("\nTroubleshooting:")
