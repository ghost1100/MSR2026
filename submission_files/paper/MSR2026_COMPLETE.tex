...
To systematize the methodological challenges we have identified, we propose a taxonomy of validity threats specific to observational AI tool research. This framework can guide future researchers in identifying and addressing potential problems.
...
This work does not attempt to measure true testing behavior and therefore does not evaluate the correctness of any AI-generated code or tests. Our conclusions depend on the structure of the AIDev dataset, which lacks file-level diffs and commit histories; different datasets may permit deeper behavioral inference. Our identification of automation artifacts relies on volume thresholds and pattern-based heuristics, which may misclassify edge cases. However, none of these factors affect the central conclusion: PR-level metadata in this dataset is insufficient for valid behavioral inference.
