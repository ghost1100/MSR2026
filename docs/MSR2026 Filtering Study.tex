...
\textbf{Stage 2 - Statistical Outlier Filtering}: Remove contributors exceeding the 99th percentile threshold ($\geq$215 PRs per user) to assess impact of high-volume accounts. The 99th percentile threshold was selected based on the empirical distribution, which exhibited a sharp inflection point separating typical users from high-volume outliers in the cumulative contribution curve.
