...
\section{Illustrative Demonstrations Using AIDev Dataset}
...
\noindent\footnotesize{\textit{Note: Shown only to demonstrate clustering structure; not used to support behavioral inference.}}
...
\textbf{Measurement Validation}: Manual validation (n$\geq$500) across languages and contexts, with bias quantification and correction.
