...
\title{Testing Behavior Varies Dramatically Across AI Coding Agents: An Empirical Study of 50,000 Pull Requests from the MSR 2026 Dataset\\
...
Table~\ref{tab:main_results} presents our primary findings. The most striking result is the dramatic variation in test contribution rates across AI agents, as visualized in Figure~\ref{fig:test_contribution_rates}.
...
\caption{Test contribution rates across AI coding agents. OpenAI Codex achieves 98.5\% while Cursor achieves only 18\%, demonstrating dramatic behavioral differences.}
...
\textbf{User Diversity Analysis}: OpenAI Codex demonstrates highest user adoption (13,421 unique users), while specialized tools like Claude Code show concentrated usage (124 users). This pattern reflects broader market adoption trends, as shown in Figure~\ref{fig:agent_distribution}.

\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{figure2_agent_distribution.png}
\caption{Market share distribution of AI coding agents in our 50,000 PR sample. OpenAI Codex dominates with 87.3\% market share, while other agents serve specialized niches.}
...
Figure~\ref{fig:statistical_analysis} provides comprehensive statistical validation of these behavioral differences.
