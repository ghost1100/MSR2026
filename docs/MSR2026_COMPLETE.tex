...
\begin{abstract}
Observational datasets of AI-assisted pull requests face methodological challenges that can invalidate behavioral inferences. We identify four critical validity threats in such datasets: agent attribution uncertainty, statistical clustering violations, measurement bias, and confounding effects. Using AIDev as a case study, we demonstrate how these threats manifest in practice and establish methodological requirements for reliable inference from observational AI tool data. This framework aims to improve research rigor by identifying necessary conditions for valid behavioral research using observational datasets.
\end{abstract}
...
We identify four critical validity threats: (1) agent attribution reliability, (2) statistical clustering violations, (3) measurement bias, and (4) confounding effects. We demonstrate how these threats manifest in observational datasets and render behavioral inference unreliable.
...
\section{Implications for Observational Research}

\textbf{Critical Disclaimer}: This paper does not present behavioral results. Any numerical examples are used solely to illustrate how validity threats distort inference and should not be interpreted as evidence of agent behavior.

The combination of attribution uncertainty, clustering violations, measurement bias, and confounding effects renders behavioral inference from such datasets unreliable. Apparent patterns in observational data likely reflect methodological artifacts rather than genuine tool capabilities.
