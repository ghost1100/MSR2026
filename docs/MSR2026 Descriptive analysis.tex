...
Our analysis reveals important structural properties: \textbf{GitHub Copilot dominates with 87.8\% of contributions} (37,042 PRs), while \textbf{Claude Code provides 12.2\%} (5,137 PRs). The dataset spans \textbf{1,934 unique users} with substantial contribution variation—from single-PR contributors (median) to one user contributing 36,596 PRs. Understanding these distributional patterns is essential for appropriate statistical analysis and methodological design.
...
This binary distribution reflects the specific AI agents captured in the MSR 2026 dataset, with GitHub Copilot representing the dominant presence. The 7:1 ratio between agents provides sufficient representation for comparative analysis while avoiding extreme imbalance issues.
...
\textbf{Binary Agent Distribution}: The dataset contains two AI agents with a manageable imbalance ratio of approximately 7:1: GitHub Copilot with 37,042 PRs (87.8\%) and Claude Code with 5,137 PRs (12.2\%). This distribution provides sufficient representation for comparative analysis while maintaining statistical validity. Figure~\ref{fig:agent_distribution} shows the real distribution computed from aidata.csv.
...
\textbf{Comparative Analysis Feasibility}: The 7:1 ratio between Copilot and Claude Code provides adequate representation for meaningful comparative studies while avoiding extreme imbalance issues that plague other datasets.
...
\textbf{Comparative Analysis Feasibility}: The 7:1 Copilot to Claude Code ratio provides adequate statistical power for meaningful comparative studies of AI agent behavior while avoiding extreme imbalance issues.
