...
\end{tabular}
\\[2pt]
\footnotesize{These values are used solely to illustrate attribution inconsistencies and are not interpreted as reflecting real tool usage.}
\end{table}
...
\\[2pt]
\footnotesize{Shown only to demonstrate clustering structure; not used to support behavioral inference.}
\end{figure}
