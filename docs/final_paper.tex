...
This section reports empirical findings addressing the research questions defined in Section~\ref{sec:research_questions}. The results are intentionally presented in two layers. First, we report automated, dataset-scale observations that describe apparent patterns in test-related activity. Second, we report manually validated findings that assess whether these apparent patterns correspond to substantive testing behavior. This separation reflects our validation-first study design and prevents conflation of metadata signals with behavioral evidence.
...
These patterns suggest differential usage models: OpenAI Codex and Cursor appear integrated into broad development workflows, while Devin and Copilot show patterns consistent with specialized or high-volume usage. The single-user dominance for Devin raises questions about data quality and potential fabrication, while Copilot's concentration among few users may reflect enterprise or power-user adoption.
