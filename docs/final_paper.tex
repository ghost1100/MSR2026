...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{../figures/contribution_inequality.png}
\caption{Distribution of pull requests per user, showing extreme contribution inequality with a log-scale histogram. Most users contribute one PR, while a few dominate with orders of magnitude more, highlighting non-independence and invalidating agent-level chi-square inference.}
\label{fig:contribution_inequality}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{../figures/agent_market_share.png}
\caption{PR volume by AI agent, illustrating market share dominance and structural biases in agent comparisons.}
\label{fig:agent_market_share}
\end{figure}
