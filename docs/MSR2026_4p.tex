...
We identify four critical threats: (1) agent attribution reliability, (2) statistical clustering violations, (3) measurement bias, and (4) confounding effects. We demonstrate how these threats render behavioral inference unreliable.
...
\section{Illustrative Demonstrations}
...
\noindent\footnotesize{\textit{Note: These values are used solely to illustrate attribution inconsistencies and are not interpreted as reflecting real tool usage.}}
